...
모듈 7(투자분석 기초 방법론) 전체 과정을 완료했습니다.

| 분석 방법 | 핵심 도구 | 참고 파일 |
|-----------|-----------|-----------|
| 매크로 분석 | 금리·물가·유가·환율 | 매크로 분석 과정 |
| 산업 분석 | Porter's 5 Forces, SWOT | 산업 분석 과정 |
| 기본적 분석 | 재무제표, PER/PBR, DCF | 기본적 분석 과정 |
| 기술적 분석 | MA·RSI·MACD·패턴·파동 | 기술적 분석 과정 |
