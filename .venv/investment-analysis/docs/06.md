...
# 주식 종목별 정규장 외 거래 제한의 이유

국내 주식시장에서 모든 종목이 정규장(09:00~15:30) 외에 '시간외 거래'나 '대체거래소(ATS)' 등에서 똑같이 거래되지 않는 이유는 **투자자 보호, 시장 안정성, 그리고 거래소가 정한 제도적 기준** 때문입니다. 

특정 종목들이 정규장 이외의 시간에 거래가 제한되거나 불가능한 대표적인 원인은 다음과 같습니다.

---

### 1. 투자경고 및 위험 종목 (시장경보제도)
주가가 단기간에 비정상적으로 급등하거나 작전 세력의 개입 정황이 의심되는 종목은 한국거래소(KRX)가 **'투자주의 ➔ 투자경고 ➔ 투자위험'** 단계를 부여합니다.
* **시간외 거래 제한:** 투자경고나 위험 종목으로 지정되면 변동성을 완화하기 위해 정규장 이후 열리는 '시간외 단일가 매매(16:00~18:00)' 거래가 제한되거나 아예 정지되기도 합니다.

### 2. 정리매매 및 단기과열 종목
* **정리매매 종목:** 상장폐지가 결정되어 마지막으로 주식을 처분할 수 있도록 기회를 주는 '정리매매' 종목은 정규장(30분 간격 단일가 매매)에서만 거래가 가능하며, 시간외 거래는 전면 금지됩니다.
* **단기과열 지정 종목:** 과열 양상을 보여 3거래일간 단일가 매매가 적용되는 종목 역시 시간외 거래 규칙이 일반 종목과 다르게 제한될 수 있습니다.

### 3. 대체거래소(ATS) 도입에 따른 종목 차등
정규장 시간 외(새벽이나 밤 등)에도 거래할 수 있는 대체거래소(Nextrade 등) 시스템의 경우, 모든 주식을 처음부터 취급하지 않습니다.
* 유동성이 풍부하고 안정적인 **주요 종목 위주로 단계적 허용**을 유도합니다.
* 이에 따라 시가총액이 작거나 거래량이 부족한 소형주, 코스닥 일부 종목 등은 대체거래소 거래 대상에서 제외되어 기존 한국거래소(KRX)의 정규장 시간 및 제한된 시간외 거래로만 매매할 수 있습니다.

### 4. 유동성(거래량) 부족 및 호가 왜곡 방지
정규장 외의 시간(장 시작 전, 장 마감 후)에는 시장에 참여하는 투자자가 매우 적습니다.
* 거래량이 너무 적은 종목을 시간외 거래에 무제한 허용하면, 적은 금액으로도 주가를 폭등시키거나 폭락시키는 **'호가 왜곡(시세 조작)'**이 발생하기 쉽습니다.
* 따라서 거래소는 유동성이 극도로 낮은 종목이나 관리종목 등은 정규장 내에서만 소화되도록 제한을 둡니다.

---

💡 **요약**
> **"종목 자체에 위험성이 있거나(경고·위험·상장폐지), 규모가 작아 시세 조작 위험이 있거나, 야간 거래(ATS) 지원 대상이 아니기 때문"**에 정규장 외 거래가 제한됩니다. 이는 소수 투자자의 독점이나 불공정 거래로부터 일반 투자자를 보호하기 위한 안전장치입니다.
